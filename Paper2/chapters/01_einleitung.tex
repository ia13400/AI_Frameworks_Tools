...
\begin{description}[style=nextline, leftmargin=0pt, font=\bfseries]
  ...
  \item[H3 (Ironie und Sarkasmus)] Das Modell erkennt keine Ironie, sondern verarbeitet ausschließlich die wörtliche Oberflächen-Polarität. Die Hypothese gilt als bestätigt, wenn das Modell durchgehend der wörtlichen Lesart folgt und die gemeinte ironische Polarität an keiner Schicht linear ablesbar ist.
\end{description}

Die Hypothesen H1 und H2 besitzen einen kausalen Kern, der den Eingriff durch Activation Patching erfordert. Hypothese H3 lässt sich teils über das beobachtbare Verhalten und teils über eine schichtweise Betrachtung prüfen.
